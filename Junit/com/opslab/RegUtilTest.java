...
public class RegUtilTest extends TestCase {
    ...
    public void testIsMatche() {
        System.out.println(RegUtil.matcher("1234", "\\d{4}"));
        System.out.println(RegUtil.matcher("123as", "\\d{4}"));

        String Wregex = "[a-zA-Z]:(?:[/\\\\][^/\\\\:*?\"<>|.][^/\\\\:*?\"<>|]{0,254})+";
        String Lregex = "(?:[/\\\\][^/\\\\:*?\"<>|.][^/\\\\:*?\"<>|]{0,254})+";

        System.out.println(RegUtil.matcher("c:\\1.txt", Wregex));
        System.out.println(RegUtil.matcher("c:/1.txt", Wregex));
        System.out.println(RegUtil.matcher("/Program Files (x86)/Tencent", Lregex));
        System.out.println(RegUtil.matcher("/ProgramFiles/Tencent", Lregex));
    }
